<template>
	<view class="policy-text">
		...
		　　我们的产品集成友盟+SDK，友盟+SDK在后台状态/静默状态需要收集您的设备Mac地址、唯一设备识别码（IMEI/android ID/IDFA/OPENUDID/GUID、SIM 卡 IMSI
		...
		　　(b)本公司（保留随时修改本政策的权利，因此请经常查看。如对本政策作出重大更改，本公司会通过网站通知的形式告知。
